  ...
  return (
    <div className="min-h-screen text-white relative overflow-x-hidden">
      ...
      <div className="relative z-10 flex flex-col items-center min-h-screen pt-6 px-3 md:px-6">
        <div className="w-full max-w-[1200px] relative rounded-xl bg-[linear-gradient(to_top,#050505_0%,#080808_25%,#0A0A0A_45%,#0D0D0D_65%,#111111_80%,#181818_100%)] overflow-hidden">
            <PurchaseTimerBanner />
            ...
            {/* Resumo dos Tickets */}
            <div className="px-2">
              <div className="bg-[#171C20] rounded-2xl p-5 border border-white/5 w-full">
            ...
            <SelectedSeatsPanel tickets={ticketSlots} seats={allSeats} onRemoveSeat={handleRemoveSeat} />
